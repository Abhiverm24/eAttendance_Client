...
const ContactForm = () => {
    ...
    const send = async (e) => {
        e.preventDefault();
        try {
            // const res = await fetch('http://localhost:4000/users/contact', {
            const res = await fetch('https://eattendance.onrender.com/users/contact', {
                method: 'POST',
                headers: {
