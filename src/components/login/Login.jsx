...
function Login() {
    ...
    const userlogin = async (e) => {
        e.preventDefault();
        try {
            if (Email === "abhishekv2403@gmail.com" && Password === 'Abhi@2403') {
                localStorage.setItem("Admin", Email)
                window.location = "/Admin"
            } else {
                // const res = await fetch('http://localhost:4000/users/Login', {
                const res = await fetch('https://eattendance.onrender.com/users/Login', {
                    method: 'POST',
                    headers: {
    ...
    return (<>
        ...
        <div className="Login-main-container">
            <div className="left">
                <h1>Welcome <span>to</span> eAttendance System </h1>
