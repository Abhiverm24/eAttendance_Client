...
function Table() {
    ...
    const reset = async () => {
        try {
            ...
            const res = await axios.post('https://eattendance.onrender.com/reset', {
    ...
    const getstudent = async () => {
        try {
            // const res = await axios.post('http://localhost:4000/getstudent', {
            const res = await axios.post('https://eattendance.onrender.com/getstudent', {
                Fac_ID,
                courses,
            })
    ...
    const attend = async () => {
        // const res = await axios.post('http://localhost:4000/update', {
        const res = await axios.post('https://eattendance.onrender.com/update', {
