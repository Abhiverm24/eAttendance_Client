...
const Course = () => {
    ...
    const postdata = (e) => {
        ...
        try {
            ...
            const res = axios.post('https://eattendance.onrender.com/addcourses', {
                Fac_ID,
                courses
            })
        } catch (error) {
    ...
    const getcourses = async (e) => {
        ...
        try {
            ...
            const res = await axios.post('https://eattendance.onrender.com/getcourses', {
                Fac_ID
            })
    ...
    const del_course = () => {
        try {
            ...
            const res = axios.post('https://eattendance.onrender.com/deletecourses', {
                Fac_ID: data.Fac_ID,
                courses: course
            })
        } catch (error) {
