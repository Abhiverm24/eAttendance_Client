...
const Student = () => {
    ...
    const submit = () => {
        try {
            ...
            for (let index = 0; index < data.length; index++) {
                ...
                const res = axios.post('https://eattendance.onrender.com/addstudent', {
    ...
    const getstudent = async () => {
        ...
        const res = await axios.get('https://eattendance.onrender.com/student-data', {
            headers: {
    ...
    const del_student = () => {
        // const res = axios.post('http://localhost:4000/delete', {
        const res = axios.post('https://eattendance.onrender.com/delete', {
            Enroll_no: student
        })
    }
    useEffect(() => {
